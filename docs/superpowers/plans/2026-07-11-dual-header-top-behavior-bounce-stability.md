...
- [ ] **Step 2: 运行 LayoutEngine 定向测试并确认 RED**
...
- [ ] **Step 1: 新增真实 safe-area-sensitive Header helper**
...
- [ ] **Step 3: 新增负 offset 可见 bounce 测试**
...
- [ ] **Step 6: 实现 presentation translation 与 context 映射**
...
- [ ] **Step 1: 将 UI 回归从标题 minY 改为分段栏 minY**
