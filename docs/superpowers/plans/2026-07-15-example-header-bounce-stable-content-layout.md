...
- [ ] **Step 2: 在 Example 中增加只读 Header 内容几何探针**
...
- [ ] **Step 5: 在临时 worktree 验证旧约束形成正确 RED**
...
- [ ] **Step 6: 在主工作区验证用户约束与全部聚焦测试 GREEN**
