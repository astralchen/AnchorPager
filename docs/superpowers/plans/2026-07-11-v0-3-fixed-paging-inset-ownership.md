...
- [ ] **Step 3: 增加示例 identifiers 并保持默认 adaptive bar**
...
- [ ] **Step 4: 更新 README 和 architecture**
...
- [ ] **Step 5: 运行示例 build 和完整 UI tests**
