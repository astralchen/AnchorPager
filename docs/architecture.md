...
本文档面向维护者，记录当前 v0.4 Child 生命周期、缓存与 reload 代际原子性阶段的架构边界和已固定契约。Task 1–3 实现、聚焦复审、Swift 6.2.4 完整验收及最终独立复审均已完成；v0.4 Ready，v0.5 实施中，Task 1 已完成，Task 2 已根据 UIKit 实测和 JXPagingView 参考验证完成设计修订。
