...
v0.7 已确认把 selection request admission 正式收口到 Host：一笔 active + 一笔 latest pending、Host identifier、Adapter 第三方执行、ViewController/Store 真实 terminal 提交。该目标契约尚未实施，详见 `docs/superpowers/specs/2026-07-15-v0-7-interaction-selection-momentum-design.md`。
