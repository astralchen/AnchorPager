...
- v0.4 Task 1–3 已完成 Host request/terminal 与 bar acknowledgement、Store payload/generation lease/CleanupPlan、ViewController staged public/provider/bar terminal 和 pre-load 路径；完整验收为框架 193 项、Example 5 项单元与 16 项 UI 测试全部通过，最终独立复审仍待完成，当前不得宣称 v0.4 Ready
