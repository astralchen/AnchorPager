...
10. `docs/superpowers/specs/2026-07-12-v0-4-child-lifecycle-cache-design.md`（涉及 v0.4 page identity、按需加载、cache window、reload generation、offset snapshot、fallback containment 或 appearance lifecycle 时）
...
14. `docs/superpowers/specs/2026-07-13-plain-page-direct-containment-design.md`（涉及无 UIScrollView 页面、直接 Pageboy containment、nil scroll target、fallback host 移除、plain page 尺寸或物理屏幕底边时）
...
12. `docs/superpowers/plans/2026-07-13-plain-page-direct-containment.md`（执行、继续、审查或验收无 UIScrollView 页面直接 Pageboy containment、fallback host 移除、nil scroll target、物理屏幕底边或 container-only pan 时）
