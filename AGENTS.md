...
9. `docs/superpowers/specs/2026-07-12-v0-4-child-lifecycle-cache-design.md`（涉及 v0.4 page identity、按需加载、cache window、reload generation、offset snapshot、fallback containment 或 appearance lifecycle 时）
