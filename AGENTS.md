...
6. `docs/superpowers/specs/2026-07-11-immersive-header-measurement-bounce-design.md`（涉及 Header Public API、沉浸式布局、automatic 测量或主容器 bounce 时）
...
4. `docs/superpowers/plans/2026-07-11-immersive-header-measurement-bounce.md`（涉及 Header Public API 收缩、沉浸式几何、automatic 测量或可见 bounce 时）
