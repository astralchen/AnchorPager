...
8. `docs/superpowers/specs/2026-07-11-fixed-paging-viewport-inset-scroll-ownership-design.md`（涉及固定分页 viewport、bar 高度、scroll discovery、inset ownership、page state 或纵向 owner 时）
...
6. `docs/superpowers/plans/2026-07-11-v0-3-fixed-paging-inset-ownership.md`（涉及 v0.3 固定分页 viewport、barInsets、scroll target 或 inset ownership 时）
