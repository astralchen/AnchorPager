...
15. `docs/superpowers/specs/2026-07-13-boundary-bounce-ownership-design.md`（涉及无滚动页双边界 bounce、顶部 overscroll mode、container/child bounce owner、业务 child bounces 租约或可见 presentation 验收时）
