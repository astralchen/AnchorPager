...
11. `docs/superpowers/plans/2026-07-13-v0-5-scroll-coordination.md`（执行、继续、审查或验收 v0.5 纵向 handoff、container pan proxy、child observation、真实 pan UI test 或顶部临时 bounce 时）
