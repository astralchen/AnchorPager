...
v0.1–v0.6 及 2026-07-14 主容器顶部 inset/固定高度 Header presentation 专项均已完成实现、全量验收和 fresh-pass，v0.5 Task 7/v0.6 当前为 Ready。后续开发可以进入 v0.7，但必须继续按对应设计和计划逐任务执行，不得跳过 TDD、UI 验收或复审门禁。
